...
caption="LAN8720 to application device interface diagram taken directly from the LAN8720 datasheet. For our application the MAC and RMII block are going to be part of our ASIC and we will have 3 such interfaces in parallel. Like in this example, both the ASIC and all the 3 LAN8720 chips will be driven by the same external reference clock signal."
>}} 
